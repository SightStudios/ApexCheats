...
local CustomImageManagerAssets = {
    ...
    DropdownArrow = {
        RobloxId = 6282522798,
        Path = "Apex/assets/DropdownArrow.png",
    ...
    CheckerLong = {
        ...
        Path = "Apex/assets/CheckerLong.png",
    ...
    SaturationMap = {
        RobloxId = 4155801252,
        Path = "Apex/assets/SaturationMap.png",
...
do
    ...
    function CustomImageManager.AddAsset(AssetName: string, RobloxAssetId: number, URL: string, ForceRedownload: boolean?)
        ...
        CustomImageManagerAssets[AssetName] = {
            ...
            Path = string.format("Apex/custom_assets/%s", AssetName),
            URL = URL,
...
local Library = {
    ...
    AccentColor = Color3.fromRGB(0, 41, 189);
...
do
    ...
    if Library.IsMobile then
        ...
        local LockUIOuter = Library:Create("Frame", {
            BorderColor3 = Color3.new(0, 0, 0);
            Position = UDim2.new(0.008, 0, 0.060, 0);
            Size = UDim2.new(0, 60, 0, 22);
            ZIndex = 200;
            Visible = true;
            Parent = ScreenGui;
...
----
getgenv().Apex = Library
if getgenv().skip_getgenv_apex ~= true then getgenv().Library = Library end
return Library
